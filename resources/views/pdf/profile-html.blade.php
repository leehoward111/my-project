        ...
        @if(!empty($accessory_data))
            <div class="section">
                ...
                @if(!empty($accessory_data['styling_concept']))
                    <p style="margin-bottom: 15px; color: #7c3aed; font-weight: 600;">{{ $accessory_data['styling_concept'] }}
                    </p>
                @endif
                ...
                <ul>
                    @foreach($accessory_data['accessories'] ?? [] as $key => $value)
                        <li><strong>{{ $labelMap[$key] ?? $key }}:</strong> {{ $value }}</li>
                    @endforeach
                </ul>

                @if(!empty($accessory_data['explanation']))
                    <p style="margin-top: 15px; color: #666; font-style: italic;">{{ $accessory_data['explanation'] }}</p>
                @endif
            </div>
        @endif
